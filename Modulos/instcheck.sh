...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/Digulgasoft/01_PRO_MANAGER/main/Modulos/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/01_PRO_MANAGER/main/Modulos/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Digulgasoft/01_PRO_MANAGER/main/Modulos/checkuser.py > /dev/null 2>&1
